...
package io.github.jlike.config.apidoc;
...
@Profile(JLikeConstants.SPRING_PROFILE_SWAGGER)
public class SwaggerConfiguration {
     ...
     */
    @Bean
    public Docket swaggerSpringfoxDocket(JLikeProperties jHipsterProperties) {
