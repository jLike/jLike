...
package io.github.jlike.config.liquibase;
...
import io.github.jlike.config.JLikeConstants;
...
public class AsyncSpringLiquibase extends SpringLiquibase {
    ...
    public void afterPropertiesSet() throws LiquibaseException {
        if (!env.acceptsProfiles(JLikeConstants.SPRING_PROFILE_NO_LIQUIBASE)) {
            if (env.acceptsProfiles(JLikeConstants.SPRING_PROFILE_DEVELOPMENT, JLikeConstants
