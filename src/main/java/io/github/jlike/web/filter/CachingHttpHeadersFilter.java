...
package io.github.jlike.web.filter;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(JLikeProperties jLikeProperties) {
        this.jLikeProperties = jLikeProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        cacheTimeToLive = TimeUnit.DAYS.toMillis(jLikeProperties.getHttp().getCache().getTimeToLiveInDays());
    }
